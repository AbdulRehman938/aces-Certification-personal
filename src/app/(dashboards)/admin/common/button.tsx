...
export default function Button({
  ...
  const baseClasses =
    "px-4 md:px-6 py-2 rounded-lg text-sm md:text-base font-medium transition-colors";

  const variantClasses = {
    primary: "bg-black text-white shadow-lg",
    secondary: "bg-white border border-black text-secondary hover:bg-primary",
    custom: "",
  };
  ...
  const mergedStyle =
    variant === "primary" ? { ...shadowStyle, ...style } : style;
