...
export default function PaymentPage() {
  ...
  const fetchMetrics = useCallback(async () => {
    ...
    try {
      const response = await axiosInstance.get<PaymentMetricsApiResponse>(
  ...
  const fetchPayments = useCallback(async () => {
    ...
    setError("");
    try {
      const response = await axiosInstance.get<PaymentsApiResponse>(
        "/admin/payments",
        {
          params: {
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-6">
        ...
        <PaymentCard
          icon={
            ...
            >
              <path
                d="M5.83337 12.5H7.50004C7.50004 13.4 8.64171 14.1667 10 14.1667C11.3584 14.1667 12.5 13.4 12.5 12.5C12.5 11.5833 11.6334 11.25 9.80004 10.8083C8.03337 10.3667 5.83337 9.81667 5.83337 7.5C5.83337 6.00833 7.05837 4.74167 8.75004 4.31667V2.5H11.25V4.31667C12.9417 4.74167 14.1667 6.00833 14.1667 7.5H12.5C12.5 6.6 11.3584 5.83333 10 5.83333C8.64171 5.83333 7.50004 6.6 7.50004 7.5C7.50004 8.41667 8.36671 8.75 10.2 9.19167C11.9667 9.63333 14.1667 10.1833 14.1667 12.5C14.1667 13.9917 12.9417 15.2583 11.25 15.6833V17.5H8.75004V15.6833C7.05837 15.2583 5.83337 13.9917 5.83337 12.5Z"
                fill="black"
              />
            </svg>
          }
