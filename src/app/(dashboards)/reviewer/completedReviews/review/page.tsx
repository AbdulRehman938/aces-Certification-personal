...
function CompletedReviewsReviewContent() {
  ...
  const [mainSectionsData] = useState<MainSection[]>(
    DUMMY_MAIN_SECTIONS as MainSection[],
  );
  const [expandedMain, setExpandedMain] = useState<{ [key: string]: boolean }>(
    () =>
      Object.fromEntries(
        (DUMMY_MAIN_SECTIONS as MainSection[]).map((ms) => [
          ms.id,
          ms.isExpanded || false,
        ]),
      ),
              ...
              {activeSubsection &&
                (() => {
                  const selectedSection = mainSectionsData
                    .flatMap((ms) => ms.sections || [])
                    .find((s) => s.name === activeSubsection);
                  ...
                  return (
                    <div>
                      ...
                      {selectedSection?.questions?.length ? (
                        selectedSection.questions.map((q, idx: number) => (
                          <div
                            key={q.id}
        ...
        <div className="mt-6">
            ...
            <div className="mt-5 space-y-6">
              <div>
                ...
                <textarea
                  ...
                  style={{ borderColor: "#E6E6E6" }}
                  placeholder="Provide a high-level summary of the reviews findings....."
                />
              </div>
          ...
          <div className="bg-white rounded-xl border border-zinc-100 p-4">
            ...
            <Button
              ...
              className="mt-6"
              onClick={() => {
                console.log("Submit Review Report");
              }}
            >
