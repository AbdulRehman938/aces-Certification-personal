...
export default function CompletedReviews() {
  ...
  return (
    <div className="p-6 bg-light-gray min-h-screen">
      <div className="mb-8">
        <h1 className="text-[24px] font-semibold text-secondary mb-2 leading-[21.6px] align-middle">Completed Reviews</h1>
        <p className="text-[15px] font-normal text-gray leading-[21.6px] align-middle">View all completed review submissions</p>
      </div>

      <h2 className="text-[18px] font-semibold text-secondary mb-2 leading-[21.6px] align-middle">Completed Reviews</h2>
          ...
          <table className="w-full min-w-250" style={{ tableLayout: "fixed" }}>
            ...
            <tbody>
              {table.getRowModel().rows.length === 0 ? (
                <tr>
                  <td colSpan={columns.length} className="px-4 py-8 text-center text-gray text-sm">No completed reviews found</td>
                </tr>
              ) : (
