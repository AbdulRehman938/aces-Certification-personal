  ...
  return (
    <div className="p-6 bg-light-gray min-h-screen">
      <div className="mb-8">
        ...
        <p className="text-[15px] font-normal text-gray leading-[21.6px] align-middle">Overview of your reviewers assignments and progress</p>
      </div>
      <div className="mb-10">
        ...
        <div className="flex flex-col gap-2 mt-6">
          <div className="flex items-center justify-between py-1">
            <h2 className="text-base font-semibold text-secondary">Assigned Reviewers</h2>
