                            ...
                            <div className="space-y-4 pl-12 pr-4">
                              ...
                              <div>
                                ...
                                q.attachments.length > 0 ? (
                                  <div className="flex gap-2 flex-wrap">
                                    {q.attachments.map(
                                      (attachment: any, fileIndex: number) => (
                                        <a
                              ...
                              <div className="mt-6 flex items-center gap-4">
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    handleReviewerNotesSave(questionId)
                                  }
                                  disabled={
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-lg w-[90%] max-w-xl p-6 shadow-lg">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Describe what additional information or documents you need from
                the applicant.
              </p>
