...
export default function FlagItemsPage() {
  ...
  const auditors = [
    { name: "Sarah Chen", email: "sarah.chen@certify.com", team: "Security & Privacy", available: true, disabled: false },
    { name: "David Park", email: "david.park@certify.com", team: "Risk & Controls", available: true, disabled: false },
    { name: "Emily Watson", email: "emily.watson@certify.com", team: "Compliance", available: false, disabled: true },
    { name: "Michael Lee", email: "michael.lee@certify.com", team: "Security & Privacy", available: true, disabled: false },
  ];
  return (
    <div className="p-3 md:p-6 bg-light-gray min-h-screen">
      ...
      <h2 className="text-[16px] font-semibold text-dull-gray leading-[19.2px] align-middle">Flagged Items</h2>
            ...
            <div className=" border border-zinc-100 rounded-md p-4">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-4">
                  <div className="w-8 h-8 rounded-full bg-zinc-100 flex items-center justify-center text-sm font-semibold">1</div>
                  <h4 className="text-sm font-medium text-secondary leading-[21.6px]">Missing signature on policy document</h4>
                </div>
                <span
              ...
              <div className="space-y-4 pl-12 pr-3">
                ...
                <div className="mt-6 flex items-center gap-4">
                  ...
                  <Button
                    variant="custom"
                    className="border rounded-lg px-6 py-2 font-semibold"
                    style={{ borderColor: "#E6E6E6", color: "#E6E6E6", background: "white" }}
                  >
                    Compliant
                  </Button>
                </div>
          ...
          <div className="bg-white rounded-md border border-zinc-100  flex flex-col">
            {isIssued ? (
              ...
              <div className="p-3 md:p-5 flex flex-col">
                <h3 className="text-lg font-semibold text-secondary mb-2">Ready for Audit</h3>
                <p className="text-sm text-gray-500 mb-6">
                  All flags reviewed. This assessment requires an audit before certification.
                </p>
              ...
              <div className="p-3 md:p-5 flex flex-col">
                <h3 className="text-lg font-semibold text-secondary mb-2">Final Decision</h3>
                <p className="text-sm text-gray-500 mb-6">
                  Review the audit report and make the final certification decision.
                </p>

                <div className="space-y-3">
                  <Button
                    variant="secondary"
                    className="w-full rounded-md px-6 py-3 font-semibold" style={{ background: "#262626", color: "white" }}
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Select an auditor to perform the compliance audit for this assessment.
                  </p>
                </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 flex items-center justify-between gap-6">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                              <path fillRule="evenodd" clipRule="evenodd" d="M6.66667 5.83333C6.66667 4.94928 7.01786 4.10143 7.64298 3.47631C8.2681 2.85119 9.11594 2.5 10 2.5C10.8841 2.5 11.7319 2.85119 12.357 3.47631C12.9821 4.10143 13.3333 4.94928 13.3333 5.83333C13.3333 6.71739 12.9821 7.56523 12.357 8.19036C11.7319 8.81548 10.8841 9.16667 10 9.16667C9.11594 9.16667 8.2681 8.81548 7.64298 8.19036C7.01786 7.56523 6.66667 6.71739 6.66667 5.83333ZM6.66667 10.8333C5.5616 10.8333 4.50179 11.2723 3.72039 12.0537C2.93899 12.8351 2.5 13.8949 2.5 15C2.5 15.663 2.76339 16.2989 3.23223 16.7678C3.70107 17.2366 4.33696 17.5 5 17.5H15C15.663 17.5 16.2989 17.2366 16.7678 16.7678C17.2366 16.2989 17.5 15.663 17.5 15C17.5 13.8949 17.061 12.8351 16.2796 12.0537C15.4982 11.2723 14.4384 10.8333 13.3333 10.8333H6.66667Z" fill="black" />
                            </svg>
                            <span className="text-base font-medium truncate">{auditor.name}</span>
                          </div>
                          <div className="flex items-center gap-2 mt-1.5 pl-6">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                              <path d="M13.3335 2.66675H2.66683C1.9335 2.66675 1.34016 3.26675 1.34016 4.00008L1.3335 12.0001C1.3335 12.7334 1.9335 13.3334 2.66683 13.3334H13.3335C14.0668 13.3334 14.6668 12.7334 14.6668 12.0001V4.00008C14.6668 3.26675 14.0668 2.66675 13.3335 2.66675ZM13.0668 5.50008L8.3535 8.44675C8.14016 8.58008 7.86016 8.58008 7.64683 8.44675L2.9335 5.50008C2.86665 5.46256 2.80811 5.41186 2.76142 5.35105C2.71473 5.29025 2.68087 5.2206 2.66188 5.14633C2.64289 5.07206 2.63916 4.9947 2.65093 4.91895C2.6627 4.8432 2.68972 4.77062 2.73035 4.70562C2.77098 4.64061 2.82438 4.58452 2.88731 4.54074C2.95025 4.49697 3.02141 4.46642 3.09649 4.45095C3.17158 4.43547 3.24902 4.43539 3.32413 4.45071C3.39925 4.46603 3.47047 4.49644 3.5335 4.54008L8.00016 7.33342L12.4668 4.54008C12.5299 4.49644 12.6011 4.46603 12.6762 4.45071C12.7513 4.43539 12.8287 4.43547 12.9038 4.45095C12.9789 4.46642 13.0501 4.49697 13.113 4.54074C13.1759 4.58452 13.2293 4.64061 13.27 4.70562C13.3106 4.77062 13.3376 4.8432 13.3494 4.91895C13.3612 4.9947 13.3574 5.07206 13.3384 5.14633C13.3195 5.2206 13.2856 5.29025 13.2389 5.35105C13.1922 5.41186 13.1337 5.46256 13.0668 5.50008Z" fill="#999999" />
                            </svg>
                            <span className="text-sm text-gray-500 truncate">{auditor.email}</span>
                          </div>
                          <div className="flex items-center gap-2 mt-1 pl-6">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                              <g clipPath="url(#clip0_699_3699)">
                                <path d="M8 0.666748L2 3.33341V7.33342C2 11.0334 4.56 14.4934 8 15.3334C11.44 14.4934 14 11.0334 14 7.33342V3.33341L8 0.666748ZM8 7.99341H12.6667C12.3133 10.7401 10.48 13.1867 8 13.9534V8.00008H3.33333V4.20008L8 2.12675V7.99341Z" fill="#999999" />
                              </g>
                              <defs>
                            ...
                            <span className="text-sm text-gray-400 truncate">{auditor.team}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="shrink-0">
                        <span
                          className={`w-24 inline-flex items-center justify-center px-3 py-0.5 rounded-md text-xs font-medium ${auditor.available
                            ? "border text-gray-500"
                            : "text-gray-500"
                            }`}
                          style={
                            auditor.available
                              ? { border: "1px solid #00B448", color: "#00B448", background: "#F2FFF7" }
                              : { background: "#F6F6F6" }
                          }
                        >
      ...
      {showReauditModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div className="absolute inset-0 bg-black/40" onClick={() => setShowReauditModal(false)} />
          <div className="relative bg-white rounded-lg w-[90%] max-w-xl p-6 shadow-lg">
            ...
            <p className="text-sm text-gray-600 mb-4">Describe your reaudit reason here....</p>
            ...
            <div className="mt-6 flex justify-end gap-3">
              <Button variant="secondary" onClick={() => setShowReauditModal(false)}>Close</Button>
              <Button variant="primary" onClick={() => { console.log("Reaudit request sent"); setShowReauditModal(false); }}>Send</Button>
            </div>
          </div>
        </div>
      )}
